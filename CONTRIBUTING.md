...
* The package manager uses C++ code and Python scripts. If you want to submit something that's in a different language, make sure that you've adjusted the rest of the project code to fit it.
