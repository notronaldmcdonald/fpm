...
if(File.exist?("/usr/local/bin/fpm"))
  ...
  if answer == "n"
    ...
    system("curl #{target_branch}/src/.fpm_glasses.rb -o /usr/local/bin/.fpm_glasses.rb")
    system("curl #{target_branch}/src/.fpm_spine_install.py -o /usr/local/bin/.fpm_spine_install.py")
    system("curl #{target_branch}/src//.fpm_spine_uninstall.py -o /usr/local/bin/.fpm_spine_install.py")
