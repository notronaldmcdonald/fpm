...
if answer == "n":
    ...
    print("Okay! Adding that to the script...")
    subprocess.run(["echo", "# Generated by constructor", ">", f"{target}.construct.rb"])
    subprocess.run(["echo", f"base = \"{target}\"", ">>", f"{target}.construct.rb"])
    deps = input("Enter any package dependencies:")
