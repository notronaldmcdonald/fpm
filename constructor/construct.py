...
print("\nThis tool will compress a binary for you.\nIt will also generate an index entry.\nIt is recommended you use this tool in your package repo.")
print("If you're creating a package to be submitted to someone else's repo, set the \'enable_pkglist_entries\' variable in the script to \'true\'.")
print("The script will be in \'~/.fpm/pkgs\'.")
